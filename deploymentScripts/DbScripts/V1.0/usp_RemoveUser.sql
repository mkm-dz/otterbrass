...
AS   
    ...
    INSERT INTO @userChannelsInternalTable(Internal_id)
      ...
      DROP CONSTRAINT FK_UserRanking;
      ...
      ALTER TABLE [UserRanking] ADD CONSTRAINT FK_UserRanking FOREIGN KEY (Internal_id) REFERENCES ChannelsOtterBrassUser(Internal_id);
